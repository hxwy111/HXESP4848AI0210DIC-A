...
#ifndef ESP_PANEL_DRIVERS_LCD_GC9B72_COMPAT
...
static esp_err_t panel_gc9b71_reset(esp_lcd_panel_t *panel)
{
    ...
    if (gc9b71->reset_gpio_num >= 0) {
#if ESP_PANEL_DRIVERS_LCD_GC9B72_COMPAT
        // GC9B72 vendor sequence: high 50 ms -> low 50 ms -> high 120 ms.
...
//  {cmd, { data }, data_size, delay_ms}
...

    {
        0x6E, (uint8_t [])
        {
            0x0B, 0x0B, 0x09, 0x09, 0x13, 0x13, 0x11, 0x11, 0x16, 0x15, 0x01, 0x04, 0x00, 0x0D, 0x1D, 0x00,
