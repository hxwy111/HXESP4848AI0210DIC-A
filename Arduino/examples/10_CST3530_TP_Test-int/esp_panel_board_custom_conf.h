 ...
 */
#define ESP_PANEL_BOARD_NAME                "HX:HX-ESP-S3-4848S021IC-A"
 ...
 */
/* ST7701 is the compatible library driver for the panel's ST7701S controller. */
 ...
 */
...
#if !ESP_PANEL_BOARD_LCD_BUS_SKIP_INIT_HOST
    /* For host */
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_SCK         (38)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA0       (4)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA1       (5)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA2       (6)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA3       (7)
#endif // ESP_PANEL_BOARD_LCD_BUS_SKIP_INIT_HOST
    /* For panel */
    ...
    #define ESP_PANEL_BOARD_LCD_RGB_VBP             (11)
    ...
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA1        (4)    //        |      D1      |   B1   |  B2    |   B4   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA2        (5)    //        |      D2      |   B2   |  B3    |   B5   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA3        (6)    //        |      D3      |   B3   |  B4    |   B6   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA4        (7)    //        |      D4      |   B4   |  B5    |   B7   |
    ...
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA11       (0)    //                       |   R0   |  R0-1  |   R0-3 |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA12       (11)    //                       |   R1   |  R2    |   R4   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA13       (12)    //                       |   R2   |  R3    |   R5   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA14       (13)     //                       |   R3   |  R4    |   R6   |
 ...
 */
#define ESP_PANEL_BOARD_LCD_VENDOR_INIT_CMD()  ST7701S_LCD_VENDOR_INIT_CMD()
 ...
 */
    ...
    #define ESP_PANEL_BOARD_TOUCH_I2C_IO_SCL            (14)
...
#define ESP_PANEL_BOARD_BACKLIGHT_TYPE          (ESP_PANEL_BACKLIGHT_TYPE_SWITCH_GPIO)
     ...
     */
    #define ESP_PANEL_BOARD_BACKLIGHT_IO        (38)    // BL_PWM feedback control
    // AP3032 backlight current is enabled when BL_PWM is low. During reset the
    // high-impedance GPIO produces the same state through the feedback network.
    #define ESP_PANEL_BOARD_BACKLIGHT_ON_LEVEL  (0)     // Active low
...
#define ESP_PANEL_BOARD_EXPANDER_I2C_IO_SCL         (40)
#define ESP_PANEL_BOARD_EXPANDER_I2C_IO_SDA         (41)
...
#define ESP_PANEL_BOARD_BACKLIGHT_PRE_BEGIN_FUNCTION(p) \
    {  \
        constexpr int BACKLIGHT_ENABLE_EXPANDER_PIN = 2; /* TCA9554 P2 / BL_EN */ \
        auto board = static_cast<Board *>(p);  \
        auto expander = board->getIO_Expander()->getBase(); \
        /* BL_EN is active high; keep the AP3032 boost converter off until the UI is ready. */ \
        expander->pinMode(BACKLIGHT_ENABLE_EXPANDER_PIN, OUTPUT); \
        expander->digitalWrite(BACKLIGHT_ENABLE_EXPANDER_PIN, LOW); \
        return true;    \
    }
