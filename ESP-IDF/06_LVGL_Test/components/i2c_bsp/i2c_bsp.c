...
/* 使用 ESP32-S3 的 I2C0 控制器。 */
#define TEST_I2C_PORT I2C_NUM_0

/* 初始化 I2C0 主机，总线速率为 300 kHz。 */
...
void I2C_scan_devices(void)
{
  ...
  if(device_count == 0)
  {
    printf("未发现任何 I2C 设备，请检查接线、电源和上拉电阻。\n");
  }
  else
  {
    printf("I2C 扫描完成，共发现 %u 个设备。\n\n",
