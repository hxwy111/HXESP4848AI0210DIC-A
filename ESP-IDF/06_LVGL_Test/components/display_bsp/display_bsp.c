...
/* HXESP4848AI0210DIC-A backlight wiring from the schematic:
 *   BL_PWM -> ESP32-S3 GPIO38 (active low)
...
esp_err_t display_bsp_hardware_reset(void)
{
    ...
    ESP_RETURN_ON_ERROR(
        /* P0/P1/P2 are outputs (LCD reset, TP reset, and BL_EN). */
        expander_configure_board_outputs(), TAG, "TCA9554 direction config failed"
    );
